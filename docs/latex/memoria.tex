...
\begin{document}
	...
	\begin{abstract}
		En los últimos cinco años, se han llevado a cabo grandes avances en el campo del Procesamiento de Lenguaje Natural (NLP). Sin embargo, muchos de esos avances han quedado limitados al ámbito académico y corporativo, sin que el público general haya podido beneficiarse de ellos.
		
		JIZT es un servicio de generación de resúmenes en la nube que, gracias al desarrollo de una aplicación multiplataforma y una API REST de libre acceso, permite que cualquier persona, desde un usuario regular hasta un desarrollador con experiencia en el campo, pueda obtener resúmenes de sus textos de manera sencilla, eficiente y ajustada a sus necesidades.
		
		La generación de estos resúmenes es, además, fruto de la utilización de los modelos más avanzados a día de hoy. Como resultado, a diferencia de otros servicios, JIZT ofrece resúmenes abstractivos, esto es, resúmenes que contienen palabras y expresiones que no están presentes en el texto original.
	\end{abstract}
	
	\renewcommand*\abstractname{Descriptores}
	\begin{abstract}
		NLP, generación de resúmenes abstractivos, \emph{Cloud Native}, API REST, arquitectura de microservicios, aplicación multiplataforma.
	\end{abstract}
