...
\begin{document}
	...
	\begin{abstract}
		En los últimos cinco años, se han llevado a cabo grandes avances en el campo del Procesamiento de Lenguaje Natural (NLP). Sin embargo, el alcance de muchos de estos avances se ha visto limitado a ciertas áreas del NLP, como la traducción automática, los \emph{bots} conversacionales, el filtrado de \emph{spam}, etc., mientras que en el caso de otras tareas, como la generación de resúmenes, sigue existiendo a día de hoy escasez de alternativas.
		
		JIZT es un servicio de generación de resúmenes en la nube que, gracias al desarrollo de una aplicación multiplataforma y de una API REST, ambos \emph{open-source}, permite que cualquier persona, desde un usuario regular hasta un desarrollador con experiencia en el campo, pueda obtener resúmenes de sus textos de manera sencilla, eficiente y ajustada a sus necesidades.
...
%	\listoftables
	...
	\begin{figure}[h]
		\centering
		\includegraphics[width=0.4\textwidth]{license}
	\end{figure}
